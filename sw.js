const CACHE_NAME = 'nursepath-v2.3.0';
...
const STATIC_ASSETS = [
  ...
  new URL('assets/icons/favicon-32.png', BASE).href,
  new URL('assets/brand/logo-wordmark-dark.png', BASE).href,
  new URL('assets/brand/logo-icon.png', BASE).href,
